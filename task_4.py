...
def get_predicted_value(k, grid_val):
	...
	phoneme_01 = get_predictions(phoneme_1_data['mu'], phoneme_1_data['s'], phoneme_1_data['p'], grid_val)
	phoneme_01 = np.sum(phoneme_01,axis=1)
	phoneme_02 = get_predictions(phoneme_2_data['mu'], phoneme_2_data['s'], phoneme_2_data['p'], grid_val)
	phoneme_02 = np.sum(phoneme_02,axis=1)

	prediction = []
	# appending "0.0" if point belongs to phoneme 1 and "1.0" if points belong to phoneme 2
